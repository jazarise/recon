...
check("core.workflow_engine",          lambda: __import__("core.workflow_engine.engine"))
check("core.plugin_loader",            lambda: __import__("core.plugin_manager.loader"))
check("core.execution_manager",        lambda: __import__("core.engine.execution_manager"))
check("core.orchestrator",             lambda: __import__("core.engine.orchestrator"))
check("core.result_store",             lambda: __import__("core.result_store"))
check("core.config",                   lambda: __import__("core.config.manager"))
check("core.project_manager",          lambda: __import__("core.project_manager"))
check("core.doctor",                   lambda: __import__("core.dependency_manager.doctor"))
check("core.correlation_engine",       lambda: __import__("core.engine.correlation_engine"))
