...
COMPLETION_REPORT = """# STAGE 7 COMPLETION REPORT
...
def main():
    with open(AUDIT_DIR / "ai_performance_report.md", "w", encoding="utf-8") as f:
        f.write(PERFORMANCE_REPORT)
    with open(AUDIT_DIR / "STAGE7_COMPLETION_REPORT.md", "w", encoding="utf-8") as f:
        f.write(COMPLETION_REPORT)
    print("Stage 7 completion reports generated successfully.")
