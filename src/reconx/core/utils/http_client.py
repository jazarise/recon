...
class HttpClient:
    ...
    @staticmethod
    def post(url: str, json: dict = None, headers: dict = None, timeout: int = 10) -> dict:
        try:
            ...
            return {
                "url": url, "status_code": 0, "headers": {}, "text": "", "json": None, "error": str(e)
            }
    ...
    def request(method: str, url: str, headers: dict = None, timeout: int = 10) -> dict:
        try:
            ...
            return {
                "url": url, "status_code": 0, "headers": {}, "text": "", "error": str(e)
            }
